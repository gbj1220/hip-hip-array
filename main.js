...
// dirtBikeBrands = ['Honda', 'Suzuki', 'Kawasaki', 'Yamaha', 'KTM']; 
// }for (let i = 0; i < dirtBikeBrands.length; i++) {
// console.log(dirtBikeBrands[i])
// } 

// Challenge 8
// Make a new EMPTY array and fill it with five values of your choice using BOTH .push AND .unshift, and then console.log out each value individually.
const dirtBikeBrands = [];
dirtBikeBrands.push('KTM');
dirtBikeBrands.push('Honda');
dirtBikeBrands.push('Kawasaki');
dirtBikeBrands.unshift('Yamaha');
dirtBikeBrands.unshift('Suzuki')
...
classMates2 = classMates.slice(3)
for (let i = 0; i < classMates2.length; i++) {
  // console.log(classMates2[i])
}
...
newStudent2 = newStudent.slice(3)
for (let i = 0; i < newStudent2.length; i++) {
  // console.log(newStudent2[i])
}
...
lessCoolDinosaurs = coolDinosaurs.join('*')
...
const superSuperDinos = superDinos.reverse()
...
const combColors = primaries.concat(secondaries);
for (i = 0; i < combColors.length; i++){
//   console.log(combColors[i])
// }
